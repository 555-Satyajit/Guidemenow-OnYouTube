...
useEffect(() => {
    const fetchItems = async () => {
      ...
      const { data, error } = await supabase
        .from('tools')
        .select('*')
        .eq('category', 'Monetization & Merch');
  ...
  return (
    <div className="bg-black py-12">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-white mb-2"> Monetization & Merch </h1>
...
export default MoneitizationCard